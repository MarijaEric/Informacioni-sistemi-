                    ...
                    <div class="card text-center">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link active" href="/aktivne-narudzbine">Aktivne porudžbine</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link disabled" href="/istorija-porudzbina">Istorija porudžbina</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-left">
                                ...
                                <div class="order" id="<?php echo $order->id ?>">
                                    <button type="button"
                                            class="<?php if(str_starts_with($order->status,'U tran')){
                                                echo 'btn btn-success';
                                    }else { echo 'btn pull left btn-primary';}  ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <?php if(str_starts_with($order->status,'U tran')){
                                            echo '';
                                        }else { echo '<button type="button" id="otkaz-button" name="' . $order->id .'" class="btn pull left btn-info">Otkazi</button>'; } ?>
...
<script type="text/javascript" src="otkazivanje.js"></script>
